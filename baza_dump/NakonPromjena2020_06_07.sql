...
INSERT INTO `admin_radnje` VALUES (18,2,'2020-06-06','Instaliran Office 2016','',8),(22,11,'2020-06-06','Provjerio sam RAM. Jedan modul je neispravan','Računalo se i dalje restarta. Potrebna je dijagnostika',10),(23,1,'2020-06-06','Instalacija programa','',1),(26,9,'2020-06-07','Ažuriranje programske podrške za e-poreznu','Nije bilo moguće pristupiti stranici e-porezna',10);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='programi na uredaju';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `instalirani_programi` VALUES (1,1,8,NULL),(2,2,8,18),(3,3,8,26),(4,4,3,NULL),(5,5,8,NULL),(6,10,10,26);
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='komponente u uredaju';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `konfiguracija` VALUES (1,6,'ispravno','',1,22),(2,6,'ispravno','',1,22),(3,1,'ispravno','Pregled',1,22),(4,2,'ispravno','',1,NULL),(5,1,'ispravno','',5,NULL),(6,1,'ispravno','',10,18),(7,4,'ispravno','',3,NULL),(8,6,'ispravno','',8,18),(9,NULL,'ispravno','',1,NULL),(10,NULL,'ispravno','',1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='podaci o nabavama';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nabava` VALUES (1,'GRADRI','infop','2020-05-14','30 PC za g101 2 PC za djelatnike 10 monitora 20 tipkovnica 20 miševa 10 UTP kabela 3m'),(3,'SOIRI','infop','2020-06-07','10 računala za djelatnike');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='podaci o uredajima\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `uredaj` VALUES (1,'PC','GRA-G101-101','g101',4,NULL,1,'2021-05-14','Asus','ASUSPRO D641SC'),(2,'PC','GRA-G101-102','g101',4,NULL,1,'2021-05-14','Asus','ASUSPRO D641SC'),(3,'PC','GRA-G101-103','g101',4,NULL,1,'2021-05-14','Asus','ASUSPRO D641SC'),(5,'Laptop','GRA-G120-201','g102',4,NULL,1,'2021-05-18','Lenovo','ThinkPad L490'),(8,'PC','GRA-G010-101','g010',1,'Na računalo je spojen \"Zebra\" printer i barkod skener',NULL,'2020-06-06','Končar','Nada N1'),(9,'PC','APU-PORTA','A001',NULL,'',NULL,'2020-06-06','Lenovo','LenThinkPadZX'),(10,'PC','GRA-G201-101','g201',3,'Računalo za obračun plaća',NULL,'2020-06-07','MSun','MS909');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='zahtjevi korisnika';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-07 21:03:06
